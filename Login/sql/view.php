...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../../driver/driver/sql/img/<?php echo $pic1 ?>" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="../../driver/driver/sql/img/<?php echo $pic2 ?>" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="../../driver/driver/sql/img/<?php echo $pic3 ?>" class="d-block w-100" alt="...">
    </div>
  </div>
