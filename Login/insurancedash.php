    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="Accepted_results.php" class="waves-effect">
                        <i class="mdi mdi-view-dashboard"></i>
                        <span>Approved Accidents</span>
                    </a>
                </li>
                <li>
                                ...
                                <div class="page-title-box">
                                    <h4>Dashboard</h4>
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Insurance_Dashboard</li>
                                        </ol>
                                </div>
                            </div>
  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body text-dark">
        ...
        <a href="sql/del.php?accid=<?php echo $accid ?>" class="btn btn-warning" >Reject</a>
        <a href="sql/accept.php?accid=<?php echo $accid ?>" class="btn btn-warning" >Accept</a>
      </div>
    </div>
  </div>
</div>
