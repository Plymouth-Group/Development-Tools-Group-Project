    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <li>
                ...
                <li>
                    <a href="RDA_database.php" class="waves-effect">
                        <i class="mdi mdi-view-dashboard"></i>
                        <span>RDA</span>
                    </a>
                </li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Insurance Datatable</h4>
                                        <p class="card-title-desc">DataTables has added Insurance database .                                    </p>

                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>Insurance Company Name</th>
                                                    <th>Insurance Company Register ID</th>
                                                    <th>Email</th>
                                                    <th>Company_Registered_Data</th>
                                                    <th>Telephone</th>
                                                    <th>Username</th>
                                                    <th>Password</th>
                                                    <th>action</th>
...

  {
    ...
    ?>
                    ...
                    <tr>
                      ...
                      <td><?php  echo $row["tegid"]   ?></td>

                      <td><?php  echo $row["email"]   ?></td>

                      <td><?php  echo $row["regnamedate"]   ?></td>

                      <td><?php  echo $row["tel"]   ?></td>
                      <td><?php  echo $row["i_username"]   ?></td>
                      <td><?php  echo $row["i_password"]   ?></td>
                      <td>
